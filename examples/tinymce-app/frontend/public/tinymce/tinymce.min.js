...
!(function () {
  ...
  const Ao = (e) => (t) => !!t && t.nodeType === e,
    ...
    Zr = (e, t) =>
      ...
      ((e) =>
        To(e) && 'A' === e.nodeName && !e.hasAttribute('href') && (e.hasAttribute('name') || e.hasAttribute('id')))(
        e
      ) ||
      es(e),
            ...
            const t = [],
              ...
              o = (e, t) => {
                ...
                t > 0 && (o.setStart(e, t - 1), o.setEnd(e, t), vi(o) || n(wi(Ci(o), !1))),
                  t < e.data.length && (o.setStart(e, t), o.setEnd(e, t + 1), vi(o) || n(wi(Ci(o), !0)));
              },
              r = e.container(),
              s = e.offset();
  ...
  const ki = (e, t) => {
    ...
    Ai = (e) =>
      e ? Oe(e.childNodes, (e, t) => (Ei(t) && 'BR' !== t.nodeName ? (e = e.concat(Ai(t))) : e.push(t), e), []) : [],
    Oi = (e) => (t) => e === t,
    Ti = (e) =>
  ...
  const Dc = Yo,
    ...
    lu = (e, t) =>
      eu(e).fold(P, (e) => (t.setStart(e.container(), e.offset()), t.setEnd(e.container(), e.offset()), !0)),
    du = (e, t, n) =>
      !(
        !((e) => !e.hasChildNodes())(t) ||
        !ou(e, t) ||
          ...
          if (((e) => m(e.start))(t))
            return ((e, t) => {
              ...
              return Dt(n, o, (n, o) => {
                const r = e.createRng();
                return (
                  r.setStart(n.container(), n.offset()), r.setEnd(o.container(), o.offset()), {range: r, forward: au(t)}
                );
              });
            })(n, t);
          if (((e) => xe(e, 'id'))(t))
    ...
    vm = (e, t, n, o = !1) => {
      ...
      return (
        ...
        (em(l) || tm(l)) &&
          ...
          em(l) && (e.isBlock(r) || (r = hm(e, n, r, s, !0)), e.isBlock(a) || (a = hm(e, n, a, i, !1)))),
  ...
  const $m = (e, t, n, o) => ({start: e, soffset: t, finish: n, foffset: o}),
    ...
    uf = (e) => {
      ...
      if (t === o && zo(t)) {
        ...
        (zo(t) && n > 0 && n < t.data.length && ((t = cf(t, n)), (n = 0)), zo(o) && r > 0 && r < o.data.length)
      ) {
        const e = cf(o, r).previousSibling;
        (o = e), (r = e.data.length);
      }
  ...
  const Kf = ba.DOM,
    ...
    Qf = (e, t) => {
      ((e, t) =>
        ((e) => (e.collapsed ? M.from(ni(e.startContainer, e.startOffset)).map(mn) : M.none()))(t).bind((t) =>
  ...
  const Ng = ['font', 'text-decoration', 'text-emphasis'],
      ...
      const i = ((e, t, n) => {
        ...
        return (
          ...
          s.isSome() && a.isSome() && i.isSome()
            ...
            : M.none()).orThunk(() => (n && (o.each((e) => kp(e.dom, e.dom.length)), r.each((e) => xp(e.dom, 0))), t))
        );
        var s, a, i, l;
    ...
    qp = (e, t, n, o = !0) => {
      ...
      if (
        (a.dom === e.getBody() ? $p(e, o) : os(a) && (wr(a), o && e.selection.setCursorLocation(a.dom, 0)), !bn(n, a))
      ) {
        const e = Bt(xn(a), n)
          ? []
          : xn((i = a))
                  ...
                  Gc(n, e.getBody(), r).fold(
                    ...
                    (s) =>
                      ((e, t, n, o) =>
                        Zc(e.dom)
                          .bind((r) =>
                            eu(e.dom).map((e) => (t ? n.isEqual(r) && o.isEqual(e) : n.isEqual(e) && o.isEqual(r)))
                          )
                          .getOr(!0))(o, n, r, s)
                        ? ((e, t) => fh(e, t))(e, o)
                        : ((e, t, n) =>
    ...
    Kh = (e, t, n) =>
      !(!nm(n) || !Vh(t, n.inline)) || !(!em(n) || !Vh(t, n.block)) || (!!tm(n) && To(t) && e.is(t, n.selector)),
    Gh = (e, t, n, o, r, s) => {
      const a = n[o],
        i = 'attributes' === o;
  ...
  const db = ['fontWeight', 'fontStyle', 'color', 'fontSize', 'fontFamily'],
    cb = (e, t) => {
      const n = e.get(t);
      return p(n)
        ? Q(n, (e) => nm(e) && 'span' === e.inline && ((e) => f(e.styles) && H(ue(e.styles), (e) => j(db, e)))(e))
        : M.none();
    },
    ...
    Fb = (e, t, n, o) =>
      Mb(e, t, n, o, o).fold(N(o), (t) => (e.dom.createFragment().appendChild(o), e.dom.rename(o, t)), N(null)),
    Ub = (e, t, n, o, r) => {
    ...
    Gv = (function e() {
      ...
      var Ae = function (e) {
        ...
        Le = function (e) {
          return 'object' === Yb(i)
            ? e instanceof i
            : e && 'object' === Yb(e) && 'number' == typeof e.nodeType && 'string' == typeof e.nodeName;
        },
        Me = function (e, t, o) {
          O[e] &&
            fv(O[e], function (e) {
        ...
        Ie = function (e) {
          ...
          return e instanceof l && !Ae(e)
            ...
            ? (X &&
                ...
                (t = vv(t, D, ' ')),
                (t = vv(t, P, ' ')),
                e.textContent !== t && (pv(n.removed, {element: e.cloneNode()}), (e.textContent = t))),
  ...
  const my = Tt.makeMap,
                ...
                ((e, n) => {
                  ...
                  if (t.isValidChild(e.name, n.toLowerCase())) {
                    for (; i; ) {
                      const t = i.next;
                      g(o, i)
                        ? (l || ((l = new pg(n, 1)), l.attr(r.forced_root_block_attrs), e.insert(l, i)), l.append(i))
                        : (d(l), (l = null)),
                        (i = t);
                    }
                    d(l);
    ...
    Qy = (e) => ({
      ...
      undoManager: {
        ...
        redo: (t, n) =>
          ((e, t, n) => {
            ...
            return (
              t.get() < n.length - 1 &&
                (t.set(t.get() + 1), (o = n[t.get()]), Vy(e, o, !1), e.setDirty(!0), e.dispatch('Redo', {level: o})),
              o
            );
          })(e, t, n),
        clear: (t, n) =>
        ...
        closest: (t) =>
          ((e, t) => {
            ...
            return M.from(e.selection.getStart(!0))
              .bind((o) =>
                $h(mn(o), (n) => ce(t, (t) => ((t, n) => (Yh(e, t.dom, n) ? M.some(n) : M.none()))(n, t)), n)
              )
              .getOrNull();
          })(e, t),
      ...
      editor: {
        getContent: (t) =>
          ((e, t) => M.from(e.getBody()).fold(N('tree' === t.format ? new pg('body', 11) : ''), (n) => xg(e, t, n)))(
            e,
            t
          ),
        setContent: (t, n) =>
    ...
    aC = (e, t, n, o) => {
      ...
      const {selectorChangedWithUnbind: a} = ((e, t) => {
        ...
        f = {
          ...
          getContent: (e) =>
            ((e, t = {}) => ((e, t, n) => eC(e).selection.getContent(t, n))(e, t.format ? t.format : 'html', t))(o, e),
          setContent: i,
  ...
  const Bx = (e, t, n, o, r, s) => {
    ...
    dk = (e, t) =>
      (e || 'table' === Lt(t) ? 'margin' : 'padding') + ('rtl' === Wn(t, 'direction') ? '-right' : '-left'),
    ck = (e) => {
      const t = mk(e);
      return (
        !e.mode.isReadOnly() &&
    ...
    mk = (e) =>
      K(
        ...
        (e) => !uk(e) && !((e) => xn(e).exists(uk))(e) && ko(e, (e) => Go(e.dom) || Yo(e.dom)).exists((e) => Go(e.dom))
      ),
    fk = (e, t) => {
      var n, o;
      const {dom: r} = e,
    ...
    Mk = (e, t) => {
      ...
      return ((e, t) => {
        ...
        if (
          ((e, t, n) =>
            t ? ((e, t) => Cx(e, t).breakAt.isNone())(e.dom, n) : ((e, t) => yx(e, t).breakAt.isNone())(e.dom, n))(
            n,
            t,
            o
          )
    ...
    zk =
      ...
      () =>
        e.apply(null, t),
    jk = (e, t) =>
      Q(((e, t) => ee(((e) => $(e, (e) => ({...Fk, ...e})))(e), (e) => (Uk(e, t) ? [e] : [])))(e, t), (e) =>
        e.action()
      ),
    Hk = (e, t) =>
      ce(((e, t) => ee(((e) => $(e, (e) => ({...Fk, ...e})))(e), (e) => (Uk(e, t) ? [e] : [])))(e, t), (e) =>
        e.action()
      ),
    $k = (e, t) => {
      const n = t ? Bc.Forwards : Bc.Backwards,
    ...
    pS = (e, t) => {
      ...
      return ((e, t) =>
        ((e, t, n = P) =>
          n(t) ? M.none() : j(e, Lt(t)) ? M.some(t) : So(t, e.join(','), (e) => pn(e, 'table') || n(e)))(
          ['td', 'th'],
          e,
          t
  ...
  const TS = (e, t, n) => (e.stype === OS.Error ? t(e.serror) : n(e.svalue)),
        ...
        we(o, e).fold(
          ...
          (e) =>
            ((e, t, n, o) =>
              we(n, o).fold(
                () =>
                  ((e, t, n) => MS(e, () => 'The chosen schema: "' + n + '" did not exist in branches: ' + LS(t)))(
                    e,
                    n,
                    o
                  ),
      ...
      switch (e.tag) {
        case 'required':
          return ((e, t, n, o) =>
            we(t, n).fold(
              () =>
                ((e, t, n) => MS(e, () => 'Could not find valid *required* value for "' + t + '" in ' + LS(n)))(
                  e,
                  n,
                  t
                ),
    ...
    YS = (e, t, n) => {
      return (
        (o = ((e, t, n) =>
          ((e, t) => (e.stype === OS.Error ? {stype: OS.Error, serror: t(e.serror)} : e))(t.extract([e], n), (e) => ({
            input: n,
            errors: e
          })))(e, t, n)),
    ...
    m_ = (e, t, n) =>
      c_(
        ...
        ((e) => {
          return (
            (t = (t) =>
              j(e, t) ? Wi.value(t) : Wi.error(`Unsupported value: "${t}", choose one of "${e.join(', ')}".`)),
            $S((e) => t(e).fold(DS, BS))
          );
          var t;
        })(n)
  ...
  const I_ = (e) => {
    ...
    tE = {
      insert: (e, t) => {
        ...
        if (
          ('LI' !== x || b || ((w = s), (s = s.parentNode), (r = x)), /^(LI|DT|DD)$/.test(r) && To(s) && i.isEmpty(w))
        )
          return void ((e, t, n, o, r) => {
            ...
            if (G_(n, o, !0) && G_(n, o, !1))
              ...
              q_(n, 'LI')
                ? (s.insertAfter(d, K_(n)), d.appendChild(s.doc.createTextNode(' ')), d.appendChild(n))
                : i.insertBefore(d, n),
                s.remove(o);
    ...
    BE = (e) => {
      ...
      if (e.selection.isCollapsed()) {
        ...
        return nx(o, e.getBody(), r)
          ...
          .map(
            (o) => () => TE(n, t)(o).each(((e) => (t) => (e.selection.setRng(t.toRange()), e.nodeChanged(), !0))(e))
          );
      }
      return M.none();
    },
              ...
              t.isDefaultPrevented() ||
                ((e, t) => {
                  Hk([{keyCode: Dm.SPACEBAR, action: zk(BE, e)}], t).each((n) => {
                    t.preventDefault(),
                      j_(e, 'insertText', {data: ' '}).isDefaultPrevented() || (n(), z_(e, 'insertText', {data: ' '}));
                  });
                })(e, t);
            });
          })(e),
  ...
  const ME = N('x-tinymce/html'),
    ...
    aN = (e, t, n) => {
      ((e, t, n) => {
        let o;
        e.on('keydown', (e) => {
          ((e) => (Dm.metaKeyPressed(e) && 86 === e.keyCode) || (e.shiftKey && 45 === e.keyCode))(e) &&
            !e.isDefaultPrevented() &&
  ...
  const _N = (e, t) => Math.abs(e.left - t),
    ...
    WN = (e) => {
      ...
      const l = (e) => e !== o && (VN(e) || Jo(e)) && n.isChildOf(e, o),
        ...
        f = (r, c) => {
          ...
          const g = r.endOffset;
          if (
            (zo(m) && 0 === f && VN(m.parentNode) && ((m = m.parentNode), (f = n.nodeIndex(m)), (m = m.parentNode)),
            !To(m))
          )
            return null;
                  ...
                  const t = (t) => {
                      if (!t.isDefaultPrevented()) {
                        ...
                        n &&
                          ...
                          (t.preventDefault(), 'drop' === t.type && OC(e, 'Dropped file type is not supported'));
                      }
                    },
                    n = (n) => {
                      Gf(e, n.target) && t(n);
    ...
    cR = (e, t, n, o) => {
      ...
      return CS(i, l - n.pattern.end.length, t).bind((d) => {
        ...
        if (lR(a)) return M.some({matches: [{pattern: a, startRng: c, endRng: c}], position: d});
        {
          ...
          return m.map((e) => {
            const t = ((e, t, n, o = !1) => YN(e, t, n.startContainer, n.startOffset, n.endContainer, n.endOffset, o))(
              r,
              s,
              e,
              o
                ...
                e.execCommand('mceInsertNewLine'),
                  n.each((t) => {
                    ...
                    n.data.charAt(t.offset - 1) === er &&
                      (n.deleteData(t.offset - 1, 1), JN(e.dom, n.parentNode, (t) => t === e.dom.getRoot()));
                  });
              }
            ),
            !0)
    ...
    ER = (e) => {
      ...
      (o.disabled = !0),
        (e.readonly = dd(e)),
        e.readonly ||
          (e.inline && 'static' === vR.getStyle(o, 'position', !0) && (o.style.position = 'relative'),
          ...
          ((e) => {
            ((e) => {
              const t = [',', '.', ';', ':', '!', '?'],
                ...
                o = () => {
                  return (
                    (t = Ld(e)), (n = Md(e)), {inlinePatterns: Ji(t), blockPatterns: Qi(t), dynamicPatternsLookup: n}
                  );
                  var t, n;
                },
        ...
        e.inline
          ...
          : ((e, t) => {
              ((e, t) => {
                ...
                t.editorContainer &&
                  ((t.editorContainer.style.display = e.orgDisplay), (e.hidden = RR.isHidden(t.editorContainer))),
    ...
    KR = (e, t) => {
      ...
      return /^ | $/.test(t)
        ? ((e, t, n) => {
            ...
            return (
              (n = fp(o, xi.fromRangeStart(t)) ? n.replace(/^ /, '&nbsp;') : n.replace(/^&nbsp;/, ' ')),
  ...
  class jA {
    ...
    render() {
      ((e) => {
        ...
        s &&
          ...
          od(e) &&
            !Uo(e.getElement()) &&
            (DR.insertAfter(DR.create('input', {type: 'hidden', name: t}), t), (e.hasHiddenInput = !0)),
    ...
    show() {
      ...
      e.hidden &&
        ((e.hidden = !1),
        e.inline ? (e.getBody().contentEditable = 'true') : (FA.show(e.getContainer()), FA.hide(e.id)),
        e.load(),
        e.dispatch('show'));
    }
    hide() {
    ...
    rO = {
      ...
      clamp: (e, t, n) => {
        ...
        const i = t.x + t.w,
          ...
          m = eO(0, a - l);
        return (
          (o += d), (r += c), n && ((s += d), (a += c), (o -= u), (r -= m)), (s -= u), (a -= m), oO(o, r, s - o, a - r)
        );
      },
      create: oO,
